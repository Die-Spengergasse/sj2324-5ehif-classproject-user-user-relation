...
public class UserContextTests
{
    ...
    {
        var testUser = new User("JungesHaus","Kalkstein","Louis","luisk1@outlook.at");
    ...
    {
        var testUser = new User("AltesHaus","Kalckstein","Luis","luisk1@outlook.de");
    ...
    public void AddUserToCollaboratorsTest()
    {
        ...
        var newUser = new User("JUNGES HAUS","Kalckstin","Luis2","luisk1@outlook.at");
    ...
    public void AddRecipeTest()
    {
        ...
        Assert.True(_context.Recipes.Any(r => r.Id == "RECTESTINGIFITWORKS"));
    }

    [Fact]
    public void DeleteRecipeTest()
    {
        var testRecipe = _context.Recipes.Find("RECTESTINGIFITWORKS");
        if (testRecipe != null)
        {
        ...
        Assert.False(_context.Recipes.Any(r => r.Id == "RECTESTINGIFITWORKS"));
    }
}